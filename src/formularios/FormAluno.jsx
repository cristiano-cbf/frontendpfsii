...
export default function FormAluno({
  ...
  useEffect(()=> {
    fetch("https://129.146.68.51/aluno9-pfsii/escolas",{method:"GET"})
    .then((resposta) => {
      return resposta.json();

    }).then((dados)=>{
      setListaEscolas(dados);
    })
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group>
                ...
                <BarraBusca name= {"escola"} placeHolder={'Informe a Escola'} dados= {listaEscolas} campoChave={"codigo"}
                 campoBusca={"nome"} funcaoSelecao={setEscolaSelecionada} valor={""}/>
