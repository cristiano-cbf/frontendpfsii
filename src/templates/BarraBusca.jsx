...
export default function BarraBusca({ name, placeHolder, dados, campoChave,
    campoBusca, funcaoSelecao, valor }) {

    //Manipula elemento input
    ...
    return (
        <Container>
            ...
            <div className="resultado">
                <ul data-resultado>
                    {
                        dadosLista && dadosLista.map(item => {
